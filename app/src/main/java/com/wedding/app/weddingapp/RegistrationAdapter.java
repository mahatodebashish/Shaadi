...
public class RegistrationAdapter {
    ...
    public long insertDetails(String fname, String lname, String currentdate) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(openHelper_ob.FNAME, fname);
        contentValues.put(openHelper_ob.LNAME, lname);
        contentValues.put(openHelper_ob.DATETIME, currentdate);
        opnToWrite();
    ...
    public Cursor queryName() {
        String[] cols = { openHelper_ob.KEY_ID, openHelper_ob.FNAME,
                openHelper_ob.LNAME,openHelper_ob.DATETIME};
        opnToWrite();
...
/*
    public long updateldetail(int rowId, String fname, String lname, String currentdate) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(openHelper_ob.FNAME, fname);
        contentValues.put(openHelper_ob.LNAME, lname);
        contentValues.put(openHelper_ob.DATETIME, currentdate);
